...
export const ReachNewHeights = () => {
  return (
    <section className="reach-new-heights" id="Home">
      <div className="reach-new-heights__content">
        <div>
          <div className="reach-new-heights__headline">
            <h1>
              Erreiche mit deinem <span>Team</span> neue Erfolge und startet
              eure erste <span>Retrospektive.</span>
            </h1>
            <p>
        ...
        <div className="reach-new-heights__information">
          <div className="reach-new-heights__information-item">
            <img
              ...
              className="information-item__icon information-item__icon--light"
            />
            <img
              src="assets/icons/icon_what-is-it-about_dark.svg"
              alt="What is it about?"
              className="information-item__icon information-item__icon--dark"
            />
            <h2>Worum geht es?</h2>
            <p>
              Scrumlr ist ein kooperatives Tool zum{" "}
              <b>Austausch von Ideen, Meinungen und Feedback.</b>
            </p>
          </div>
          ...
          <div className="reach-new-heights__information-item">
            ...
            <p>
              ...
              <b>Website aufrufen und auf Start klicken.</b>
            </p>
          </div>
        </div>
      </div>
